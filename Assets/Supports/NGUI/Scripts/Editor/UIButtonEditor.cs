...
public class UIButtonEditor : UIButtonColorEditor
{
	...
	{
		serializedObject.FindProperty("enableColorChange").boolValue = EditorGUILayout.Toggle("Enable Color Change", serializedObject.FindProperty("enableColorChange").boolValue, GUILayout.Width(100f));
