...
public class UIButton : UIButtonColor
{
	...
	{
		// It must have visible(alpha>0) sprite to function. 
		// To hide the button sprite, you can move it far away and move collider back to place.
		return (mState.ToString () == "Pressed");
	}
